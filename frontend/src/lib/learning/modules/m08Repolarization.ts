...
const s8Interactions: LearningInteraction[] = [
  compactInteraction({ id: "m08-s8-triad", kind: "compare", prompt: "Compare variant, pericarditis-compatible, and secondary/nonspecific patterns.", instructions: "Complete at least five discriminator rows before ranking.", subskills: ["discriminate", "calibrate_confidence"], feedback: s8Feedback, accessibility: access("Navigate a real comparison table with row and column headers.", "Each triad row is announced across all cases before any category label."), leftCaseConcept: "early_repolarization_or_variant", rightCaseConcept: "pericarditis_compatible", thirdCaseConcept: "secondary_or_nonspecific_st_t", dimensions: [
    { id: "distribution", label: "Distribution", leftAnswer: "Regional precordial pattern without territorial reciprocal proof", rightAnswer: "Diffuse distribution may be compatible when supported", thirdAnswer: "Distribution follows QRS context or remains nonspecific" },
    { id: "qrs", label: "QRS context", leftAnswer: "Narrow QRS without a secondary repolarization driver", rightAnswer: "No QRS driver explains the widespread ST-T change", thirdAnswer: "QRS abnormality may explain the secondary change" },
    { id: "j-st", label: "J/ST morphology", leftAnswer: "J-point elevation or notching may support a variant pattern", rightAnswer: "Widespread ST change may be compatible; morphology alone is insufficient", thirdAnswer: "Describe proportional ST-T change in QRS context" },
    { id: "pr", label: "PR/baseline evidence", leftAnswer: "No supportive PR or baseline change", rightAnswer: "PR or baseline change may support compatibility if readable", thirdAnswer: "No specific PR pattern is established" },
    { id: "reciprocal", label: "Reciprocal evidence", leftAnswer: "No territorial reciprocal pattern", rightAnswer: "aVR or V1 opposition may occur but is not diagnostic alone", thirdAnswer: "Separate altered-depolarization discordance from reciprocity" },
    { id: "prior", label: "Prior/context", leftAnswer: "Stability may support a variant after a valid comparison", rightAnswer: "Symptoms and serial data are needed for stronger inference", thirdAnswer: "Prior may show a stable secondary pattern" },
  ] }),
